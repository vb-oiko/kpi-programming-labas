...
const b1Text = (y = "y") => `2 ${dot(y)} ${y}`;
const b1Val = (y) => 2 * y;
const b1DerText = (y = "y") => `2`;
const b1DerVal = (y) => 2;

const b2Text = (y = "y") => `\\ln(1 + 4 ${dot(y)} ${y})`;
const b2Val = (y) => Math.log(1 + 4 * y);
const b2DerText = (y = "y") => `\\frac{4}{1+ 4 ${dot(y)} ${y}}`;
const b2DerVal = (y) => 4 / (1 + 4 * y);
...
const r1Text = "\\frac{2}{y}";
const r2Text = "\\frac{4}{y+4y^2}";
const r1Val = (y) => 2 / y;
const r2Val = (y) => 4 / (y + 4 * y * y);

const rPoly = "4y^2-7y-6 = 0";
