...
const b1Text = (y = "y") => `6 \\sqrt{${y}}`;
const b1Val = (y) => 6 * Math.sqrt(y);
const b1DerText = (y = "y") => `\\frac{3}{\\sqrt{${y}}}`;
const b1DerVal = (y) => 3 / Math.sqrt(y);

const b2Text = (y = "y") => `4 \\ln(1 + ${y})`;
const b2Val = (y) => 4 * Math.log(1 + y);
const b2DerText = (y = "y") => `\\frac{4}{1+ ${y}}`;
const b2DerVal = (y) => 4 / (1 + y);

const cText = (y = "y") => `2 ${dot(y)}  ${y}`;
const cVal = (y) => 2 * y;
const cDerText = (y = "y") => `2`;
const cDerVal = (y) => 2;
...
const r1Text = "\\frac{3}{2 \\sqrt{y}}";
const r2Text = "\\frac{2}{1+y}";
const r1Val = (y) => 3 / (2 * Math.sqrt(y));
const r2Val = (y) => 2 / (1 + y);

const rPoly = "2y^{\\frac{3}{2}} -3y +2y^{\\frac{1}{2}} +3 = 0";
